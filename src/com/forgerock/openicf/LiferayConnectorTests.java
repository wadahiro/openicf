...
/**
 * Attempts to test the {@link LiferayConnector} with the framework.
 * 
 * @author johannes
 * @version 1.0
 * @since 1.0
 */
public class LiferayConnectorTests { 

    /*
     * Example test properties. On your computer, these are defined in: 
     * /home/johannes/.connector-liferay.properties (your "user.home" directory). 
     */
    ...
    //set up logging
    private static final Log log = Log.getLog(LiferayConnectorTests.class);
