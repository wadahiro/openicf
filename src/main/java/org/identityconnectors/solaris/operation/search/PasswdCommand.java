...
public class PasswdCommand {
	...
	private static final Log log = Log.getLog(PasswdCommand.class);
	...
	public static SolarisEntry getEntry(String line, String username) {
        ...
        if (!username.equals(foundUser)) {
            log.warn("The fetched username differs from what was expected (in passwd -S): fetched = '" +  foundUser + "', expected = '" + username + "'.");
            return null;
        }
