 ...
 * 
 * Subclasses of this class contains implementation of methods that differ between UNIX-like
 * systems. The specific implementation used for executing the commands is
 * determined by the connector configuration.
 * 
 * Implementation note: The goal of this interface was to add support for several UNIX
 * flavors without changing the original connector code too much (although it really needs
 * refactoring).
 * 
...
public abstract class UnixModeDriver {
	...
	protected SolarisConnection conn;

	public UnixModeDriver(SolarisConnection conn) {
		super();
		this.conn = conn;
	}
