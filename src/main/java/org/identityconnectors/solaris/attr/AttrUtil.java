...
public class AttrUtil {
	...
	public static AttributeInfo convertAccountSunAttrToAttrInfo(boolean sunCompat, AccountAttribute origAttr) {
		if (sunCompat) {
			return null;
		}
	...
	public static NativeAttribute convertAccountIcfAttrToNative(boolean sunCompat, String icfAttrName) {
		return AccountAttribute.forAttributeName(convertAccountIcfAttrToSun(sunCompat, icfAttrName)).getNative();
	}
