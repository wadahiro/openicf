...
/**
 * Attempts to test the {@link USDConnector} with the framework.
 *
 * @author $author$
 * @version $Revision$ $Date$
 */
public class USDConnectorTests {

    /*
    * Example test properties.
    * See the Javadoc of the TestHelpers class for the location of the public and private configuration files.
    */
    private static final PropertyBag properties = TestHelpers.getProperties(USDConnector.class);
    ...
    //set up logging
    private static final Log log = Log.getLog(USDConnectorTests.class);
    ...
    protected ConnectorFacade getFacade(USDConfiguration config) {
        ConnectorFacadeFactory factory = ConnectorFacadeFactory.getInstance();
        // **test only**
        APIConfiguration impl = TestHelpers.createTestConfiguration(USDConnector.class, config);
