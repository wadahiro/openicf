...
/**
 * Main implementation of the USD Connector
 *
 * @author $author$
...
@ConnectorClass(
        displayNameKey = "USD",
        configurationClass = USDConfiguration.class)
public class USDConnector implements PoolableConnector, AuthenticateOp, ResolveUsernameOp, CreateOp, DeleteOp, SchemaOp, ScriptOnConnectorOp, ScriptOnResourceOp, SearchOp<String>, SyncOp, TestOp, UpdateAttributeValuesOp {
    /**
     * Setup logging for the {@link USDConnector}.
     */
    private static final Log log = Log.getLog(USDConnector.class);

    /**
     * Place holder for the Connection created in the init method
     */
    private USDConnection connection;

    /**
     * Place holder for the {@link Configuration} passed into the init() method
     * {@link USDConnector#init(org.identityconnectors.framework.spi.Configuration)}.
     */
    private USDConfiguration configuration;
    ...
    public void init(Configuration configuration1) {
        this.configuration = (USDConfiguration) configuration1;
        this.connection = new USDConnection(this.configuration);
    }

    /**
     * Disposes of the {@link USDConnector}'s resources.
     *
