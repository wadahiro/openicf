...
import org.forgerock.openicf.usd.CAServiceDeskConnector;
import org.forgerock.openicf.usd.CAServiceDeskConfiguration;
...
public class TAMConnectorTest {
    ...
    private CAServiceDeskConfiguration config;
    ...
    public void setUpClass() throws Exception {
        properties = TestHelpers.getProperties(CAServiceDeskConnector.class);
        config = new CAServiceDeskConfiguration();
        ...
        config.setUSDWebServiceURL(configurationFileURL);
    ...
    protected ConnectorFacade getFacade() {
        ...
        // **test only**
        APIConfiguration impl = TestHelpers.createTestConfiguration(CAServiceDeskConnector.class, config);
